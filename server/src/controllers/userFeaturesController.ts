...
export function handleGetSavedItems(req: Request, res: Response): void {
...
export function handleCreateSavedItem(req: Request, res: Response): void {
  const userId = authenticateRequest(req, res);
  if (!userId) return;
...
export function handleDeleteSavedItem(req: Request, res: Response): void {
  const userId = authenticateRequest(req, res);
  if (!userId) return;
...
export function handleGetConversations(req: Request, res: Response): void {
  const userId = authenticateRequest(req, res);
  if (!userId) return;
...
export function handleGetConversationDetails(req: Request, res: Response): void {
  const userId = authenticateRequest(req, res);
  if (!userId) return;
...
export function handleAddMessage(req: Request, res: Response): void {
  const userId = authenticateRequest(req, res);
  if (!userId) return;
