import { Conversation, ConversationMessage } from '../types/index.js';

// In-memory User-Scoped Conversations Repository (PostgreSQL abstraction ready)
const conversationsStore = new Map<string, Conversation>(); // conversationId -> Conversation
...
export function createConversation(userId: string, title: string, initialMessage?: ConversationMessage): Conversation {
...
export function addMessageToConversation(
  ...
  message: { sender: 'user' | 'assistant'; text: string; ragResponse?: any }
