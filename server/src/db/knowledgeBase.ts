import { Source, DocumentChunk, Standard, CertificationScheme, Laboratory, HallmarkingCentre } from '../types/index.js';
...
export const HALLMARKING_CENTRES: HallmarkingCentre[] = [
  {
    id: 'ahc-delhi-01',
...
export const DOCUMENT_CHUNKS: DocumentChunk[] = [
  {
    id: 'chk-3042-01',
