...
export function createUser(data: { email: string; name: string; authProvider: 'email' | 'google' | 'demo'; isDemo?: boolean }): User {
...
export function updateUserProfile(userId: string, profileData: Partial<UserProfile>): User | undefined {
